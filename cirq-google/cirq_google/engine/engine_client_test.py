...
def test_create_job(client_constructor):
    ...
    assert client.create_job(
        ...
        program_id='prog',
        job_id='job0',
        processor_selector=ProcessorSelector(
            "processor0", DeviceConfigKey('RUN_NAME', 'CONFIG_ALIAS')
        ),
                ...
                scheduling_config=quantum.SchedulingConfig(
                    ...
                    processor_selector=quantum.SchedulingConfig.ProcessorSelector(
                        ...
                        device_config_key=quantum.DeviceConfigKey(
                            run_name='RUN_NAME', config_alias='CONFIG_ALIAS'
                        ),
                    ),
                ),
                description='A job',
    ...
    # Test with deprecated processor_ids
    assert client.create_job(
        project_id='proj',
        program_id='prog',
        job_id=None,
